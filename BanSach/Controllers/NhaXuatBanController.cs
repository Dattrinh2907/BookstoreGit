...
namespace BanSach.Controllers
{
    public class NhaXuatBanController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNXB,TenNXB,DiaChi,SDT,Fax,Email,Website")] NhaXuatBan nhaXuatBan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNXB,TenNXB,DiaChi,SDT,Fax,Email,Website")] NhaXuatBan nhaXuatBan)
        {
            if (ModelState.IsValid)
            {
